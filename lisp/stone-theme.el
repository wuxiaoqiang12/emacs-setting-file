...
(let ((class '((class color) (min-colors 89)))
      ...
      (highlight-line '(:underline nil :background "#CCDEED")) ; #FFF876, #F5F5F5 or #CCDEED or #888a85 or #FFFFCC
      ...
      (region '(:background "#babdb6")) ; #3B3B3F or #d3d7cf
      (shadow '(:foreground "#7F7F7F"))
      (string '(:foreground "#4e9a06")) ; #8FB171 or #036A07 or #D0372D or #23238E or #20590C
      (subject '(:weight bold :foreground "#FF8C00"))
      (symlink '(:foreground "deep sky blue"))
      (volatile-highlight '(:background "#d3d7cf"))
  ...
  (custom-theme-set-faces
   'stone
   `(default ((,class (:foreground ,base00 :background "#FFFFFF" )))) ;; foreground #1a1a1a
   `(bold ((,class (:weight bold :foreground "black"))))
   `(bold-italic ((,class (:weight bold :slant italic :foreground "black"))))
   `(italic ((,class (:slant italic :foreground ,base00))))
   `(underline ((,class (:underline t))))
   `(cursor ((,class (:background "#0FB300"))))
   `(ibuffer-dired-buffer-face ((,class (:foreground "#3465a4"))))
   `(ibuffer-read-only-buffer-face ((,class (:foreground "#75507b"))))

   ;; ;; Highlighting faces
   `(fringe ((,class (:foreground ,base00 :background ,"#ffffff" ))))
   ...
   `(isearch ((,class (:weight bold :underline "#F3CC67" :foreground "#2e3436" :background "#f57900"))))
   `(isearch-fail ((,class (:weight bold :foreground "black" :background "#FF9999"))))
   `(lazy-highlight ((,class (:underline "#F3CC67" :background "#e9b96e" :foreground "#2e3436"))))
   ...
   ;; Mode line faces
   ;; `(mode-line ((,class (:box (:line-width 1 :color ,base00) :foreground ,base00 ))))
   `(mode-line ((,class (:box (:line-width 1 :color ,base00) :foreground ,base00 :background "#999999"))))
   ;; `(mode-line-inactive ((,class (:box (:line-width 1 :color "#4E4E4C") :foreground "#F0F0EF" :background "#9B9C97"))))
   ;; `(mode-line-buffer-id ((,class (:weight bold :foreground "white" :background "#3F3B3B"))))
   ;; `(mode-line-emphasis ((,class (:weight bold :foreground "white"))))
   ;; `(mode-line-highlight ((,class (:foreground "yellow"))))

   ;; Escape and prompt faces
   `(minibuffer-prompt ((,class (:weight bold :foreground "#3465a4"))))
   `(minibuffer-noticeable-prompt ((,class (:weight bold :foreground "#3465a4" ))))
   `(escape-glyph ((,class (:foreground "#008ED1"))))
   `(error ((,class (:foreground "red"))))
   `(warning ((,class (:weight bold :foreground "orange"))))
   `(success ((,class (:foreground "green"))))

   `(ido-subdir ((,class (:foreground "#CF6A4C"))))
   `(ido-first-match ((,class (:foreground "#8F9D6A"))))
   `(ido-only-match ((,class (:foreground "#8F9D6A"))))
   `(gui-element ((,class (:background "#D4D0C8" :foreground "black"))))
   `(text-cursor ((,class (:background "yellow" :foreground "black"))))
   `(vertical-border ((,class (:foreground "#ffffff" :background  "#ffffff"))))

   ;; Font lock faces
   `(font-lock-builtin-face ((,class (:foreground "#3465a4"))))
   `(font-lock-comment-delimiter-face ((,class (:foreground "#729fcf")))) ; #696969
   `(font-lock-comment-face ((,class (:slant italic :foreground "#729fcf")))) ; #696969
   `(font-lock-constant-face ((,class (:foreground "#c4a000" :weight bold))))
   `(font-lock-doc-face ((,class (:foreground "#c17d11"))))
   `(font-lock-doc-string-face ((,class (:foreground "#75507b"))))
   `(font-lock-function-name-face ((,class (:weight bold :foreground "#3465a4"))))
   `(font-lock-keyword-face ((,class (:weight bold :foreground "#ce5c00")))) ; #3654DC
   ...
   `(font-lock-type-face ((,class (:weight bold :foreground "#5c3566"))))
   `(font-lock-variable-name-face ((,class (:foreground "#a40000")))) ; #ef2929 or #4e9a06
   `(font-lock-warning-face ((,class (:weight bold :foreground "#ef2929"))))
   `(font-latex-math-face ((,class (:foreground "#8f5902"))))
   `(font-latex-sedate-face ((,class (:foreground "#204a87"))))
   `(font-latex-warning-face ((,class (:foreground "#ef2929" :bold t))))

   `(ibuffer-help-buffer-face ((,class (:slant italic :foreground "#729fcf")))) ;
   `(ibuffer-hidden-buffer-face ((,class (:weight bold :foreground "#ef2929"))))
   `(ibuffer-occur-match-face ((,class (:weight bold :foreground "#ef2929"))))
   `(ibuffer-special-buffer-face ((,class (:weight bold :foreground "#ce5c00")))) ;
   `(ibuffer-title-face ((,class (:weight bold :foreground "#5c3566"))))
   ...
   `(comint-highlight-input ((,class (:weight bold :slant italic))))
   `(comint-highlight-prompt ((,class (:weight bold :foreground "#8ae234"))))
   ...
   `(css-property ((,class (:foreground "#3465a4"))))
   `(css-selector ((,class (:weight bold :foreground "#ce5c00"))))
   ...
   `(info-xref ((,class (:underline t :foreground "#3465a4")))) ; unvisited cross-references
   `(info-xref-visited ((,class (:underline t :foreground "#75507b")))) ; previously visited cross-references
   `(light-symbol-face ((,class (:background "#FFFFA0"))))
   `(linum ((,class (:foreground ,"#729fcf" :background ,"#ffffff" :box (:line-width 2 :color ,"#ffffff"))))) ; #1662AF
   ...
   `(show-paren-match ((,class (:foreground "#E2464C" :background "#73d216"))))
   `(show-paren-mismatch ((,class (:background "#ad7fa8" :foreground "#2e3436"))))
   ...
   `(helm-ff-dotted-directory ((t (:foreground ,base00 :background nil :weight bold))))
   `(helm-ff-dotted-symlink-directory ((t (:foreground ,base0E :background nil :weight bold))))
   ...
   ;; neoTree
   '(neo-banner-face ((t (:foreground "black"))))
   '(neo-dir-link-face ((t (:foreground "#205081" :weight bold))))
   '(neo-file-link-face ((t (:foreground "#14892C"))))
   '(neo-header-face ((t (:foreground "midnight blue"))))
   '(neo-root-dir-face ((t (:foreground "midnight blue" :weight bold))))
